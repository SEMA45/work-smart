    ...
    <div className="w-full min-h-[3.5rem] h-14 bg-white flex items-center justify-between px-4">
      ...
      <div className="h-full flex items-center space-x-2">
        ...
        <div className="relative group">
          <div className="bg-blue-600 hover:bg-blue-500 transition-all rounded-full px-4 h-8 w-28 text-white text-base flex justify-center items-center select-none cursor-pointer">
            new
          </div>
