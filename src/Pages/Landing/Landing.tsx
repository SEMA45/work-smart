    ...
    <div className="w-screen h-fit">
      <header className="w-full py-10">
        <div className="w-full h-16 px-20 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2 tracking-wider">
            <Link to="/login" className="bg-inherit text-gray-600 text-base py-2 px-5 rounded-full hover:opacity-80 transition-all flex justify-center items-center">
              Sign in
            </Link>
            <Link to="" className="bg-blue-600 text-white text-base py-2 pt-3 px-6 rounded-full hover:opacity-80 transition-all flex justify-center items-center">
              Get started today
            </Link>
          </div>
        </div>
      ...
      <main className="p-20 w-full">
        ...
        <div className="w-full flex justify-center items-center space-x-4 mt-4">
          <Link to="" className="bg-gray-700 text-white text-sm h-9 px-4 pt-1 rounded-full hover:opacity-80 transition-all flex justify-center items-center">
            Get 1 month free
          </Link>
          <Link to="" className="bg-inherit border bordr-gray-700 text-gray-600 text-base h-9 px-4 pt-1 rounded-full hover:opacity-80 transition-all flex justify-center items-center">
            Contact Support
          </Link>
        </div>
      </main>
